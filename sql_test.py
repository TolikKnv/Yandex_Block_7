...
# Альтернативный способ - объединить оба запроса в один и выполнить его методом executescript.
# query = '''
# CREATE TABLE IF NOT EXISTS directors(
#     id INTEGER PRIMARY KEY,
#     full_name TEXT,
...
# Вставляем данные в таблицу video_products.(1 -ый способ)
# query = '''
...
# Вставляем данные в таблицу video_products.(2 -ой способ)
# cur.execute(
...
# Вставляем данные в обе таблицы с помощью метода executemany.
directors = [
    (1, 'Текс Эйвери', 1908),
